...
st.image("Pictures/Concept1.png", caption="Concept 1 Image", use_container_width=True)
st.markdown("""
**Description:**
...
st.image("Pictures/Concept2.png", caption="Concept 2 Image", use_container_width=True)
st.markdown("""
**Description:**
