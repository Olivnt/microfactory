...
st.image("Pictures/Concept1.png", caption="Concept 1 Image", se_container_width=True)
st.markdown("""
**Description:**
...
st.image("Pictures/Concept2.png", caption="Concept 2 Image", se_container_width=True)
st.markdown("""
**Description:**
